...
class Core extends EventEmitter {
  ...
  * _quote (query) {
    ...
    // Reaching this point means the best next hop is known, but its liquidity curve is not.
    // This can happen if the next hop had BROADCAST_CURVES set to false, and/or if this connector
    // had SAVE_CURVES set to false, as well as if the route was configured as a default route.
